...
public class DoctorView extends javax.swing.JFrame {
    ...
    private void loadComboBoxes() {
        ...
        jComboBox6.removeAllItems(); jComboBox6.addItem("Select one");
        if (hResp.isSuccess()) {
        ...
        // Pacientes para buscar historial
        jComboBox5.removeAllItems(); jComboBox5.addItem("Select one");
        ...
        // Hospitalizar desde cita — combo pacientes (jComboBox8)
        jComboBox8.removeAllItems(); jComboBox8.addItem("Select one");
        for (packagee.model.Patient p : StorageHospital.getInstance().getAllPatients().values()) {
    ...
    if (resp.isSuccess()) {
        ...
        for (HashMap<String, Object> ap : apts) {
            ...
            if (patIdObj != null) {
                ...
                if (pat != null) patientName = pat.getFirstname() + " " + pat.getLastname();
            }
    ...
    private void initComponents() {
        ...
        ) { boolean[] canEdit={false,false,false,false,false,false}; public boolean isCellEditable(int r,int c){return canEdit[c];} });
        ...
        jLabel9.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel9.setText("User");
        jTextField8.setFont(new java.awt.Font("Yu Gothic UI", 0, 18));
        jTextField9.setFont(new java.awt.Font("Yu Gothic UI", 0, 18));
        jLabel10.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel10.setText("Password");
        ...
        jLabel14.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel14.setText("Appointment ID");
        ...
        jButton3.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jButton3.setText("Accept"); jButton3.addActionListener(evt->jButton3ActionPerformed(evt));
        jLabel15.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel15.setText("Reschedule medical appointment");
        jLabel16.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel16.setText("Appointment");
        ...
        jButton4.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jButton4.setText("Accept"); jButton4.addActionListener(evt->jButton4ActionPerformed(evt));
        jLabel17.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel17.setText("New time appointment");
        jTextField13.setFont(new java.awt.Font("Yu Gothic UI",0,18));
        jLabel18.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel18.setText("Reason for appointment");
        jTextField14.setFont(new java.awt.Font("Yu Gothic UI",0,18));
        jSeparator2.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jLabel19.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel19.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel19.setText("Complete medical appointment");
        jLabel20.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel20.setText("Appointment");
        ...
        jLabel21.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel21.setText("Diagnosis");
        jLabel22.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel22.setText("Observations");
        jLabel23.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel23.setText("Recommended treatment");
        jLabel24.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel24.setText("Follow-up indication");
        jButton5.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jButton5.setText("Complete"); jButton5.addActionListener(evt->jButton5ActionPerformed(evt));
        jLabel25.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel25.setText("Hospitalization");
        jLabel27.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel27.setText("Reason for hospitalization");
        jLabel28.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel28.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel28.setText("Date of entry");
        jTextField21.setFont(new java.awt.Font("Yu Gothic UI",0,18));
        jLabel29.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel29.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel29.setText("Estimated duration");
        jTextField22.setFont(new java.awt.Font("Yu Gothic UI",0,18));
        jLabel30.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jLabel30.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); jLabel30.setText("Observations");
        jTextArea1.setColumns(20); jTextArea1.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jTextArea1.setRows(5); jScrollPane1.setViewportView(jTextArea1);
        jButton6.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jButton6.setText("Generate"); jButton6.addActionListener(evt->jButton6ActionPerformed(evt));
        ...
        jRadioButton5.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jRadioButton5.setText("Requests");
        jRadioButton6.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jRadioButton6.setText("Patient ID");
        jTextArea5.setColumns(20); jTextArea5.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jTextArea5.setRows(5); jScrollPane6.setViewportView(jTextArea5);
        jTextArea6.setColumns(20); jTextArea6.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jTextArea6.setRows(5); jScrollPane7.setViewportView(jTextArea6);
        jTextArea7.setColumns(20); jTextArea7.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jTextArea7.setRows(5); jScrollPane8.setViewportView(jTextArea7);
        jTextArea8.setColumns(20); jTextArea8.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jTextArea8.setRows(5); jScrollPane9.setViewportView(jTextArea8);
        jSeparator4.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jButton13.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jButton13.setText("Cancel"); jButton13.addActionListener(evt->jButton13ActionPerformed(evt));
        ...
        jTextArea9.setColumns(20); jTextArea9.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jTextArea9.setRows(5); jScrollPane10.setViewportView(jTextArea9);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(new Object[][]{{null,null,null,null,null,null,null},{null,null,null,null,null,null,null},{null,null,null,null,null,null,null},{null,null,null,null,null,null,null}},new String[]{"Appointment ID","Medication name","Dose","Administration route","Treatment duration","Additional instructions","Frecuency"}) { Class[] types={java.lang.String.class,java.lang.String.class,java.lang.String.class,java.lang.String.class,java.lang.String.class,java.lang.String.class,java.lang.String.class}; boolean[] canEdit={false,false,false,false,false,false,false}; public Class getColumnClass(int c){return types[c];} public boolean isCellEditable(int r,int c){return canEdit[c];} });
        jScrollPane2.setViewportView(jTable1);
        jButton7.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jButton7.setText("Add"); jButton7.addActionListener(evt->jButton7ActionPerformed(evt));
        jButton10.setFont(new java.awt.Font("Yu Gothic UI",0,18)); jButton10.setText("Prescribe"); jButton10.addActionListener(evt->jButton10ActionPerformed(evt));
    ...
    private void panelRound2MousePressed(java.awt.event.MouseEvent evt) { x=evt.getX(); y=evt.getY(); }
    private void panelRound2MouseDragged(java.awt.event.MouseEvent evt) { this.setLocation(this.getLocation().x+evt.getX()-x, this.getLocation().y+evt.getY()-y); }
    private void btnXActionPerformed(java.awt.event.ActionEvent evt) { System.exit(0); }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (appointmentId == null || appointmentId.equals("Select one")) {
            JOptionPane.showMessageDialog(this, "Selecciona una cita", "Error", JOptionPane.ERROR_MESSAGE); return;
        }
        Response response = controller.acceptAppointment(appointmentId, String.valueOf(userData.get("id")));
        if (response.isSuccess()) {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Éxito", JOptionPane.INFORMATION_MESSAGE);
            loadAppointmentsTable(false); loadComboBoxes();
        } else {
            JOptionPane.showMessageDialog(this, response.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (jRadioButton6.isSelected()) {
            ...
            if (selectedPatient == null || selectedPatient.equals("Select one")) {
                JOptionPane.showMessageDialog(this, "Selecciona un paciente", "Error", JOptionPane.ERROR_MESSAGE); return;
            }
            ...
            if (aptsResp.isSuccess()) {
                ...
                for (HashMap<String,Object> ap : apts) {
                    if ("PENDING".equals(String.valueOf(ap.get("status")))) { appointmentId = (String) ap.get("id"); break; }
                }
            }
            if (appointmentId == null) {
                JOptionPane.showMessageDialog(this, "El paciente no tiene citas PENDING", "Error", JOptionPane.ERROR_MESSAGE); return;
            }
            ...
            if (response.isSuccess()) { JOptionPane.showMessageDialog(this, response.getMessage(), "Éxito", JOptionPane.INFORMATION_MESSAGE); loadComboBoxes(); }
            else { JOptionPane.showMessageDialog(this, response.getMessage(), "Error", JOptionPane.ERROR_MESSAGE); }
        } else if (jRadioButton5.isSelected()) {
            String hospId = (String) jComboBox6.getSelectedItem();
            if (hospId == null || hospId.equals("Select one")) {
                JOptionPane.showMessageDialog(this, "Selecciona una hospitalización", "Error", JOptionPane.ERROR_MESSAGE); return;
            }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (appointmentId == null || appointmentId.equals("Select one") || medicationName.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Completa los campos requeridos", "Error", JOptionPane.ERROR_MESSAGE); return;
        }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(this, "Selecciona un medicamento de la tabla", "Error", JOptionPane.ERROR_MESSAGE); return;
        }
