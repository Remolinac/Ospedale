...
public class HospitalizationController {
    ...
    public Response requestHospitalization(String patientId, String doctorId,
        ...
        if (roomType == null || roomType.trim().isEmpty() || roomType.equals("Select one")) {
    ...
    public Response approveHospitalization(String hospitalizationId, String doctorId) {
        if (hospitalizationId == null || hospitalizationId.trim().isEmpty() || hospitalizationId.equals("Select one")) {
    ...
    public Response getPendingHospitalizationsForDoctor(String doctorId) {
        if (doctorId == null || doctorId.trim().isEmpty()) {
            return new Response(false, "Error: Doctor ID missing", null);
        }
